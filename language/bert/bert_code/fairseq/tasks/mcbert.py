...
class McbertTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--nota-loss-weight', default=50.0, type=float,
                            help='loss weight for the nota loss')
        parser.add_argument('--mlm-loss-weight', default=5.0, type=float,
                            help='loss weight for the k-class mlm loss')
