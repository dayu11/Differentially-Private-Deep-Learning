...
class Dictionary(object):
    ...
    def __init__(
        ...
        if extra_special_symbols:
            print('Add extra symbols {} into dictionary, start_idx: {}'.format(extra_special_symbols, self.unk_index + 1))
    ...
    @classmethod
    def load(cls, f, ignore_utf_errors=False, extra_special_symbols=None):
        ...
        ```
        """
        d = cls(extra_special_symbols=extra_special_symbols)
