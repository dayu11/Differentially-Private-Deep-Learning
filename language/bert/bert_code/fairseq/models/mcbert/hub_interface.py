...
class McbertHubInterface(nn.Module):
    """A simple PyTorch Hub interface to mcbert.
    ...
    def extract_features_aligned_to_words(self, sentence: str, return_all_hiddens: bool = False) -> torch.Tensor:
        """Extract mcbert features, aligned to spaCy's word-level tokenizer."""
        from fairseq.models.mcbert import alignment_utils
    ...
    def disambiguate_pronoun(self, sentence: str) -> bool:
        ...
        assert hasattr(self.task, 'disambiguate_pronoun'), \
            'mcbert.disambiguate_pronoun() requires a model trained with the WSC task.'
        with utils.eval(self.model):
