...
class ElectraHubInterface(nn.Module):
    """A simple PyTorch Hub interface to electra.
    ...
    def extract_features_aligned_to_words(self, sentence: str, return_all_hiddens: bool = False) -> torch.Tensor:
        """Extract electra features, aligned to spaCy's word-level tokenizer."""
        from fairseq.models.electra import alignment_utils
    ...
    def disambiguate_pronoun(self, sentence: str) -> bool:
        ...
        assert hasattr(self.task, 'disambiguate_pronoun'), \
            'electra.disambiguate_pronoun() requires a model trained with the WSC task.'
        with utils.eval(self.model):
